...
class SettingProfileUserViewController: UIViewController {
    ...
    @IBAction func photoProfileAction(_ sender: Any){
        self.performSegue(withIdentifier:URLConstants.ACCOUNT.managerProfileViewToPhotoUserView, sender: nil)
    }
    
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        if segue.destination is PhotoProfileViewController{
    ...
    @IBAction func goBackSettingProfileAction(_ sender: Any) {
        self.performSegue(withIdentifier:URLConstants.ACCOUNT.managerProfileViewToSettingProfileView, sender: nil)
    }
