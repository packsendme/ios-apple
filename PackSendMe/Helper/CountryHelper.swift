...
class CountryHelper {
    ...
    func createCountries() -> [CountryModel]{
        ...
        if countries.isEmpty{
            ...
            let brazil = CountryModel(countryImage:#imageLiteral(resourceName: "iconBrazil"), name:NSLocalizedString("country-brazil", comment:""),cod:NSLocalizedString("brazil-cod", comment:""), format:NSLocalizedString("brazil-format", comment:""))
